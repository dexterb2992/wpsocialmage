! function e(t, n, i) {
    ...
    4: [function(e, t, n) {
        ...
        function r(e) {
            ...
            }, 0), s.on(this.menuEl, "click", this.clickCallbackFn), s.on(document, "keydown", this.keydownCallbackFn), s.on(window, "resize", this.destroyCallbackFn);
        ...
        o.prototype.touchstartHandler = function() {
            ...
            var t, n, i, o, r, l, a = document.createElement("div"),
                c = e.children,
                m = c.length,
                h = 0,
                p = 13;
            for (a.className = u, i = 0; m > i; i++) t = c[i], n = document.createElement("div"), n.textContent = t.textContent, n._muiPos = i, t.selected && (h = i), a.appendChild(n);
            a.children[h].setAttribute("selected", !0), this.origIndex = h, this.currentIndex = h;
            var v = document.documentElement.clientHeight,
                b = m * d + 2 * f;
            return b = Math.min(b, v), s.css(a, "height", b + "px"), p += h * d, p = -1 * p, o = -1 * e.getBoundingClientRect().top, r = v - b + o, l = Math.max(p, o), l = Math.min(l, r), s.css(a, "top", l + "px"), a
            ...
            this.menuEl.parentNode.removeChild(this.menuEl), this.selectEl.focus(), s.off(this.menuEl, "click", this.clickCallbackFn), s.off(document, "keydown", this.keydownCallbackFn), s.off(document, "click", this.destroyCallbackFn), s.off(window, "resize", this.destroyCallbackFn)
        }, t.exports = {
            initListeners: function() {
                for (var e = document, t = e.querySelectorAll(c), n = t.length - 1; n >= 0; n--) i(t[n]);
                l.onNodeInserted(function(e) {
